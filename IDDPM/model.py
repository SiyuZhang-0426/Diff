...
from utils import make_betas_cosine_schedule, extract
...
class IDDPM:
    ...
    def add_noise(
        ...
        sqrt_one_minus_alpha_cumprod = (1.0 - alphas_cumprod[timesteps]).flatten() ** 0.5
        while len(sqrt_one_minus_alpha_cumprod.shape) < len(original_samples.shape):
            sqrt_one_minus_alpha_cumprod = sqrt_one_minus_alpha_cumprod.unsqueeze(-1)
        return sqrt_alpha_prod * original_samples + sqrt_one_minus_alpha_cumprod * noise
